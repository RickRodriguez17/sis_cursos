...
@section('content')
    <div>
        ...
        <p class="mt-2 text-sm text-slate-500">
            Guarda tus cursos y aprende a tu ritmo.
        </p>
        <form class="mt-7 space-y-5" method="post">
            @csrf
            <div>
                <label class="erp-label" for="name">Nombre completo</label>
                <input
                    class="erp-input"
                    id="name"
                    name="name"
            ...
            <div>
                <label class="erp-label" for="password_confirmation">Confirmar contraseña</label>
                <input
                    class="erp-input"
        ...
        <p class="mt-6 text-center text-sm text-slate-500">
            ¿Ya tienes cuenta?
            <a class="font-bold text-indigo-600 hover:text-indigo-800" href="{{ route('login') }}">
                Ingresa
            </a>
        </p>
    </div>
